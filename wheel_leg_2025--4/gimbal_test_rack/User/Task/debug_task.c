...
//			
//            log_scope_get_data(vision_rx.target_yaw_angle 	);
//            log_scope_get_data(vision_rx.target_pit_angle 	);
//            log_scope_get_data(vision_rx.target_pit_vel 	);
//            log_scope_get_data(vision_rx.target_yaw_vel );
...
//            log_scope_get_data(gimbal.yaw_vision_vel.pid.output);
...
//          log_scope_get_data(no_online_imu);
			...
			log_scope_get_data(gimbal.yaw_angle.pid.ref);
//			log_scope_get_data(vision.target_yaw_angle);
			log_scope_get_data(gimbal.yaw_angle.pid.fdb);
			
            log_scope_get_data(vision.rx[0].data.yaw_vel);
			
//			log_scope_get_data(gimbal.yaw_angle.pid.output);
			log_scope_get_data(gimbal.yaw_spd.pid.ref);
			log_scope_get_data(gimbal.yaw_spd.pid.fdb);
