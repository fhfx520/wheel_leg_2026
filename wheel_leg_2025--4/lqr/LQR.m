...
% 腿长：0.18m
% Q = diag([5000, 8000 , 50000, 4000,    150000 , 1200, 150000 , 1200,    180000, 1000]);
% R = diag([400, 400, 100, 100]);

% Q = diag([2000, 2000, 20000, 1000, 80000, 500, 80000, 500, 80000, 1000]);
% R = diag([250, 250, 100, 100]);%0.22 22调这个QR

Q = diag([1000, 2000, 30000, 1000, 40000, 100, 40000, 100, 40000, 500]);
R = diag([1000, 1000, 200, 200]);%0.13 调这个QR



[L.L, L.L_l, L.L_r] = deal(0.13);            % 0.20m 腿长
