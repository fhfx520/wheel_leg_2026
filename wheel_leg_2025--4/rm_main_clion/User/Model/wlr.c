//{2.21943, 5.02052, -8.58235, -2.35321, 43.4665, 3.04403, -15.5341, -0.272993, -29.8989, -2.62615},
//{2.21943, 5.02052, 8.58235, 2.35321, -15.5341, -0.272993, 43.4665, 3.04403, -29.8989, -2.62615}
//};//fenghao
//{{-0.820126, -2.29147, -6.52414, -1.9139, -16.1423, -1.13808, -5.38177, -0.522154, -5.94544, -0.727286},
//{-0.820126, -2.29147, 6.52414, 1.9139, -5.38177, -0.522154, -16.1423, -1.13808, -5.94544, -0.727286},
//{1.06266, 2.92749, -13.2105, -4.22026, 41.9956, 2.54746, -17.7063, -0.704632, -28.0293, -2.50974},
//{1.06266, 2.92749, 13.2105, 4.22026, -17.7063, -0.704632, 41.9956, 2.54746, -28.0293, -2.50974}
//};
...
////{{-0.0, -0.0, -6.15491, -1.54683, -14.4315, -1.11676, -5.50198, -0.610412, -6.8081, -0.8861},
////{-0.0, -0.0, 6.15491, 1.54683, -5.50198, -0.610412, -14.4315, -1.11676, -6.8081, -0.8861},
////{-0.0, -0.0, -12.3949, -3.37274, 43.7047, 2.90055, -12.1217, -0.12453, -25.4916, -2.14794},
////{-0.0, -0.0,12.3949, 3.37274, -12.1217, -0.12453, 43.7047, 2.90055, -25.4916, -2.14794}
////};
//{{-0.0, -0.0, -0.0, -1.49824, -15.1354, -1.1655, -5.52374, -0.621567, -8.43385, -0.952286},
//{-0.0, -0.0, -0.0, 1.49824, -5.52374, -0.621567, -15.1354, -1.1655, -8.43385, -0.952286},
//{-0.0, -0.0, -0.0, -0.0, 38.3854, 2.51735, -12.9268, -0.277064, -34.0505, -2.47284},
//{-0.0, -0.0, -0.0, -0.0, -12.9268, -0.277064, 38.3854, 2.51735, -34.0505, -2.47284}
//};
...
//           if(wlr.side[i].Fn_kal < 10.0f && rotate_flag == 0)
					if(wlr.side[i].Fn_kal < 4.0f  && rotate_flag == 0 && wlr.high_flag == 1 && wlr.jump_flag == 0 && double_cnt <= 0 && chassis.recover_flag == 0 && wlr.sky_over == 0 && wlr.sky_flag == 0 &&  KEY_PRESS_POWER && yaw_err_see < 0.5f)
...
//				x3_balance_zero = 0.20f;			
    ...
    if (wlr.jump_flag == 1 && wlr.jump_pre) {  			
        ...
        if ( (fabs(lqr.X_fdb[4]) > 1.40f && fabs(lqr.X_fdb[6]) > 1.40f && wlr.crash_flag && double_cnt <= 0) ||  (fabs(lqr.X_fdb[4]) > 1.50f && fabs(lqr.X_fdb[6]) > 1.50f && double_cnt > 0  && wlr.crash_flag ) ) {
			if (   wlr.crash_flag ) {
			wlr.jump_flag = 2;
			wlr.crash_flag  = 0;
								wlr.high_flag	= 0;	
...
//				 wlr.side[i].T0 = pid_calc(&pid_ph0[i],-1.2f,lqr.X_fdb[i*2+4]) ;	 
        ...
        if( vmc[i].quadrant == 4 || vmc[i].quadrant == 3 || fabs(chassis_imu.pit) > 1.2f || fabs(lqr.X_fdb[4] - lqr.X_fdb[6]) > 0.8f ||  fabs(lqr.X_diff[4]) > 1.2f ||  fabs(lqr.X_diff[6])  > 1.2f  ) {//防止输出力矩过大
			quadrant_cnt ++;		
			if (quadrant_cnt > 200 ){
				chassis.recover_flag = 1;	
				wlr.high_flag	= 0;	}
    ...
    for (int i = 0; i < 2; i++) {
		...
		if ( wlr.crash_flag || wlr.jump_flag == 2 || wlr.jump_flag == 3)
			lqr.U_ref[i] *= 0.0f;
		else if ( (wlr.crash_flag || wlr.jump_flag == 2) && double_cnt > 0 )
			lqr.U_ref[i] *= 0.8f;
		else if(chassis.recover_flag >= 1 || wlr.sky_flag == 3 ||wlr.sky_flag == 4 )
				lqr.U_ref[i] *= 0.0f;		
