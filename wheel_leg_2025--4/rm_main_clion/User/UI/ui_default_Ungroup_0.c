...
void _ui_init_default_Ungroup_0() {
    ...
    ui_default_Ungroup_0.option.start_x = 108;
    ui_default_Ungroup_0.option.start_y = 836;
    ui_default_Ungroup_0.option.color = 0;
    ui_default_Ungroup_0.option.str_length = 4;
    ui_default_Ungroup_0.option.width = 3;
	if (wlr.high_flag == 0)
		strcpy(ui_default_Ungroup_NewText->string, "Low");
	else if (wlr.high_flag == 1)
		strcpy(ui_default_Ungroup_NewText->string, "Mid");
	else
		strcpy(ui_default_Ungroup_NewText->string, "Man");		
