...
uint32_t x0 = 1700, y0_location = 600;
...
void _ui_init_default_group5_0(void) {
    ...
    ui_default_group5_VMC_ae->start_y = y0_location + LegLength[0]/2*arm_sin_f32(-wlr.pit_fdb);
    ui_default_group5_VMC_ae->end_x = x0 + LegLength[0]/2*arm_cos_f32(-wlr.pit_fdb);//E
    ui_default_group5_VMC_ae->end_y = y0_location - LegLength[0]/2*arm_sin_f32(-wlr.pit_fdb);
