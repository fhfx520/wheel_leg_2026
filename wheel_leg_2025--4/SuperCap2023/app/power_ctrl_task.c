...
//										0.006f, 0.001f, 0.0f);//电压环  0.006f, 0.001f, 0.0f	
    ...
    PID_struct_init(&current_loop, DELTA_PID, 1.50, 0, 1.50, 0, 0,
		...
		//SBSUPERCAP
//		PID_struct_init(&buffer_loop, DELTA_PID, 0, -10, 10, 0, 0,
//                    0.0f, 2.5f, 0.0f);//90
//		PID_struct_init(&power_loop, DELTA_PID, 15, -15, 15, 0, 0,
//                     0.0395f, 0.0055f, 0.04f);// 0.018f, 0.01f, 0.015f  0.015   0.000085  0.0 \  0.0165f, 0.002f, 0.0f
//    PID_struct_init(&current_loop, DELTA_PID, 1.50, 0, 1.50, 0, 0,
//										0.0066f, 0.00195f, 0.0067f);//??????0.00023f, 0.00129f, 0.0005f 0.006f, 0.002f, 0.008f  0.0172f, 0.002f, 0.0048f   0.0092f, 0.001f, 0.0022f????????????????????????0.0172f, 0.002f, 0.0f  0.0221f, 0.002f, 0.0f 0.0061f, 0.0005f, 0.0f  dmax0.005f???pid  0.0056f, 0.002f, 0.0005f
//		PID_struct_init(&charge_voltage_loop, DELTA_PID, 1.50, 0, 1.50, 0, 0,
//										0.0065f, 0.001f, 0.0f);//?????  0.006f, 0.001f, 0.0f	
	/*********0713 toll **********/
	// 先调电流后调功率和电压
