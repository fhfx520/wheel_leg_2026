...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB14     ------> ADC1_IN5
    */
    GPIO_InitStruct.Pin = V_chassis_Pin|V_cap_Pin|V_bat_Pin;
  ...
  */
    ...
    PA7     ------> ADC2_IN4
    */
    GPIO_InitStruct.Pin = V_cap_Pin|T1_Pin|T2_Pin|T3_Pin
                          |stander_3_3v_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB14     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOA, V_chassis_Pin|V_cap_Pin|V_bat_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(GPIOA, V_cap_Pin|T1_Pin|T2_Pin|T3_Pin
                          |stander_3_3v_Pin);
