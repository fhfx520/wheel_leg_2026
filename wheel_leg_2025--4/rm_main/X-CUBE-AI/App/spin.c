...
#define AI_SPIN_MODEL_SIGNATURE     "0xeff1b3f8026220d4a8219cd00e3b501e"
...
#define AI_TOOLS_DATE_TIME   "2026-09-13T02:23:11+0800"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_SPIN_N_BATCHES
#define AI_SPIN_N_BATCHES         (1)

static ai_ptr g_spin_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_spin_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  &_encoder_encoder_0_Gemm_output_0_layer, 0x748192cd, NULL)
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool spin_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_activations_map(g_spin_activations_map, 1, params)) {
    /* Updating activations (byte) offsets */
    
    obs_output_array.data = AI_PTR(g_spin_activations_map[0] + 0);
    obs_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 0);
    obs_history_output_array.data = AI_PTR(g_spin_activations_map[0] + 100);
    obs_history_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 100);
    _encoder_encoder_0_Gemm_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 600);
    _encoder_encoder_0_Gemm_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 600);
    _encoder_encoder_1_Elu_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 600);
    _encoder_encoder_1_Elu_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 600);
    _encoder_encoder_2_Gemm_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 100);
    _encoder_encoder_2_Gemm_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 100);
    _encoder_encoder_1_1_Elu_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 356);
    _encoder_encoder_1_1_Elu_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 356);
    _encoder_encoder_4_Gemm_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 100);
    _encoder_encoder_4_Gemm_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 100);
    _Concat_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 112);
    _Concat_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 112);
    _actor_actor_0_Gemm_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 224);
    _actor_actor_0_Gemm_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 224);
    _actor_encoder_1_Elu_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 224);
    _actor_encoder_1_Elu_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 224);
    _actor_actor_2_Gemm_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 736);
    _actor_actor_2_Gemm_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 736);
    _actor_encoder_1_1_Elu_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 0);
    _actor_encoder_1_1_Elu_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 0);
    _actor_actor_4_Gemm_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 256);
    _actor_actor_4_Gemm_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 256);
    _actor_encoder_1_2_Elu_output_0_output_array.data = AI_PTR(g_spin_activations_map[0] + 0);
    _actor_encoder_1_2_Elu_output_0_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 0);
    actions_output_array.data = AI_PTR(g_spin_activations_map[0] + 128);
    actions_output_array.data_start = AI_PTR(g_spin_activations_map[0] + 128);
    return true;
  }
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool spin_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_weights_map(g_spin_weights_map, 1, params)) {
    /* Updating weights (byte) offsets */
    
    _encoder_encoder_0_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _encoder_encoder_0_Gemm_output_0_weights_array.data = AI_PTR(g_spin_weights_map[0] + 0);
    _encoder_encoder_0_Gemm_output_0_weights_array.data_start = AI_PTR(g_spin_weights_map[0] + 0);
    _encoder_encoder_0_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _encoder_encoder_0_Gemm_output_0_bias_array.data = AI_PTR(g_spin_weights_map[0] + 64000);
    _encoder_encoder_0_Gemm_output_0_bias_array.data_start = AI_PTR(g_spin_weights_map[0] + 64000);
    _encoder_encoder_2_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _encoder_encoder_2_Gemm_output_0_weights_array.data = AI_PTR(g_spin_weights_map[0] + 64512);
    _encoder_encoder_2_Gemm_output_0_weights_array.data_start = AI_PTR(g_spin_weights_map[0] + 64512);
    _encoder_encoder_2_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _encoder_encoder_2_Gemm_output_0_bias_array.data = AI_PTR(g_spin_weights_map[0] + 97280);
    _encoder_encoder_2_Gemm_output_0_bias_array.data_start = AI_PTR(g_spin_weights_map[0] + 97280);
    _encoder_encoder_4_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _encoder_encoder_4_Gemm_output_0_weights_array.data = AI_PTR(g_spin_weights_map[0] + 97536);
    _encoder_encoder_4_Gemm_output_0_weights_array.data_start = AI_PTR(g_spin_weights_map[0] + 97536);
    _encoder_encoder_4_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _encoder_encoder_4_Gemm_output_0_bias_array.data = AI_PTR(g_spin_weights_map[0] + 98304);
    _encoder_encoder_4_Gemm_output_0_bias_array.data_start = AI_PTR(g_spin_weights_map[0] + 98304);
    _actor_actor_0_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _actor_actor_0_Gemm_output_0_weights_array.data = AI_PTR(g_spin_weights_map[0] + 98316);
    _actor_actor_0_Gemm_output_0_weights_array.data_start = AI_PTR(g_spin_weights_map[0] + 98316);
    _actor_actor_0_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _actor_actor_0_Gemm_output_0_bias_array.data = AI_PTR(g_spin_weights_map[0] + 112652);
    _actor_actor_0_Gemm_output_0_bias_array.data_start = AI_PTR(g_spin_weights_map[0] + 112652);
    _actor_actor_2_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _actor_actor_2_Gemm_output_0_weights_array.data = AI_PTR(g_spin_weights_map[0] + 113164);
    _actor_actor_2_Gemm_output_0_weights_array.data_start = AI_PTR(g_spin_weights_map[0] + 113164);
    _actor_actor_2_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _actor_actor_2_Gemm_output_0_bias_array.data = AI_PTR(g_spin_weights_map[0] + 145932);
    _actor_actor_2_Gemm_output_0_bias_array.data_start = AI_PTR(g_spin_weights_map[0] + 145932);
    _actor_actor_4_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _actor_actor_4_Gemm_output_0_weights_array.data = AI_PTR(g_spin_weights_map[0] + 146188);
    _actor_actor_4_Gemm_output_0_weights_array.data_start = AI_PTR(g_spin_weights_map[0] + 146188);
    _actor_actor_4_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _actor_actor_4_Gemm_output_0_bias_array.data = AI_PTR(g_spin_weights_map[0] + 154380);
    _actor_actor_4_Gemm_output_0_bias_array.data_start = AI_PTR(g_spin_weights_map[0] + 154380);
    actions_weights_array.format |= AI_FMT_FLAG_CONST;
    actions_weights_array.data = AI_PTR(g_spin_weights_map[0] + 154508);
    actions_weights_array.data_start = AI_PTR(g_spin_weights_map[0] + 154508);
    actions_bias_array.format |= AI_FMT_FLAG_CONST;
    actions_bias_array.data = AI_PTR(g_spin_weights_map[0] + 155276);
    actions_bias_array.data_start = AI_PTR(g_spin_weights_map[0] + 155276);
    return true;
  }
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_SPIN_MODEL_NAME,
      .model_signature   = AI_SPIN_MODEL_SIGNATURE,
  ...
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
  ...
  err = ai_spin_create(network, AI_SPIN_DATA_CONFIG);
  if (err.type != AI_ERROR_NONE) {
    return err;
  }
  
  if (ai_spin_data_params_get(&params) != true) {
    err = ai_spin_get_error(*network);
    return err;
  }
#if defined(AI_SPIN_DATA_ACTIVATIONS_COUNT)
  /* set the addresses of the activations buffers */
  for (ai_u16 idx=0; activations && idx<params.map_activations.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_activations, idx, activations[idx]);
  }
#endif
#if defined(AI_SPIN_DATA_WEIGHTS_COUNT)
  /* set the addresses of the weight buffers */
  for (ai_u16 idx=0; weights && idx<params.map_weights.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_weights, idx, weights[idx]);
  }
#endif
  if (ai_spin_init(*network, &params) != true) {
    err = ai_spin_get_error(*network);
  }
  return err;
}
...
AI_API_ENTRY
ai_buffer* ai_spin_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_spin_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    AI_NETWORK_OBJ(network)->magic = AI_MAGIC_CONTEXT_TOKEN;
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ok &= spin_configure_weights(net_ctx, params);
  ok &= spin_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_spin_forward(ai_handle network, const ai_buffer* input)
{
