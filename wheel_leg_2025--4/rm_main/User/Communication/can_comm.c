...
//	dm_motor_init(&joint_motor[3], CAN_CHANNEL_1, JOINT_RS_CMD_ID, 2.43732119f, JOINT_RS_REC_ID);//RS 2.62299991 2.3627491			2.42180824 2.44345903
	...
	dm_motor_init(&joint_motor[0], CAN_CHANNEL_1, JOINT_LB_CMD_ID, 2.840708256f, JOINT_LB_REC_ID);
	dm_motor_init(&joint_motor[1], CAN_CHANNEL_1, JOINT_LS_CMD_ID, 0.888198137f, JOINT_LS_REC_ID);
	dm_motor_init(&joint_motor[2], CAN_CHANNEL_1, JOINT_RB_CMD_ID, 4.150419712f, JOINT_RB_REC_ID);
	dm_motor_init(&joint_motor[3], CAN_CHANNEL_1, JOINT_RS_CMD_ID, 2.491211653f, JOINT_RS_REC_ID);
