...
uint8_t state;				//未使用
uint16_t T0_state;			//未使用
uint16_t quadrant_cnt = 0;
float L_REF = 0.24f;		//未使用

float W0_REF;					//未使用
float recover_length = 0.18f;	//未使用
float feed_leg;					//未使用
float wlr_test_t0;				//未使用
float wlr_test_fy;				//未使用
uint32_t rotate_cnt;			//未使用
int32_t double_cnt;
float yaw_err_see;
float aaa;
...
{0.0727682, 0.137973, -1.47971, -0.727712, 9.58579, 1.29604, -8.82474, -1.18285, -7.44177, -2.14868}, 
{0.0727682, 0.137973, 1.47971, 0.727712, -8.82474, -1.18285, 9.58579,  1.29604, -7.44177, -2.14868}};
