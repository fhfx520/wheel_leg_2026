};
...
//Q = diag([3000, 4000 , 8000, 3000,    50000 , 800, 50000 , 800,    120000, 1000]);
//R = diag([500, 500, 230, 230]);
//{{-1.62676, -3.25072, -2.19185, -1.38484, -13.3527, -1.66854, -4.69751, -0.675301, -4.67708, -1.02523},
//{-1.62676, -3.25072, 2.19185, 1.38484, -4.69751, -0.675301, -13.3527, -1.66854, -4.67708, -1.02523},
//{0.858235, 1.64389, -2.62729, -1.80868, 18.7374, 1.8761, -10.9197, -0.819991, -15.5592, -2.38387},
//{0.858235, 1.64389, 2.62729, 1.80868, -10.9197, -0.819991, 18.7374, 1.8761, -15.5592, -2.38387}

//Q = diag([3000, 4000 , 8000, 3000,    50000 , 800, 50000 , 800,    150000, 1000]);
//R = diag([500, 500, 230, 230]);
//{{-1.62939, -3.25464, -2.19185, -1.38484, -13.3667, -1.67028, -4.71144, -0.677043, -5.06089, -1.04952},
//{-1.62939, -3.25464, 2.19185, 1.38484, -4.71144, -0.677043, -13.3667, -1.67028, -5.06089, -1.04952},
//{0.847346, 1.62722, -2.62729, -1.80868, 18.6813, 1.869, -10.9757, -0.82709, -17.3815, -2.48654},
//{0.847346, 1.62722, 2.62729, 1.80868, -10.9757, -0.82709, 18.6813, 1.869, -17.3815, -2.48654}

//Q = diag([3000, 4000 , 8000, 3000,    80000 , 300, 80000 , 300,    50000, 300]);
//R = diag([500, 500, 250, 250]);
//{{-1.62242, -3.36885, -2.16709, -1.3699, -14.837, -1.48694, -4.57787, -0.620916, -3.50847, -0.882162},
//{-1.62242, -3.36885, 2.16709, 1.3699, -4.57787, -0.620916, -14.837, -1.48694, -3.50847, -0.882162},
//{0.84299, 1.64133, -2.56266, -1.76441, 20.1698, 1.67831, -11.1416, -0.76974, -9.71671, -1.68638},
//{0.84299, 1.64133, 2.56266, 1.76441, -11.1416, -0.76974, 20.1698, 1.67831, -9.71671, -1.68638}

//Q = diag([3000, 4000 , 1000, 4000,    80000 , 1000, 80000 , 1000,    80000, 1000]);
//R = diag([500, 500, 400, 400]);
//{{-1.66462, -3.49252, -0.696701, -1.39896, -16.5858, -1.93582, -3.90007, -0.626055, -3.51588, -0.919935},
//{-1.66462, -3.49252, 0.696701, 1.39896, -3.90007, -0.626055, -16.5858, -1.93582, -3.51588, -0.919935},
//{0.516411, 1.02076, -0.800131, -1.66406, 16.8831, 1.57943, -10.8866, -0.843912, -10.1145, -1.93397},
//{0.516411, 1.02076, 0.800131, 1.66406, -10.8866, -0.843912, 16.8831, 1.57943, -10.1145, -1.93397}

//Q = diag([3000, 3000 , 1000, 4000,    80000 , 1200, 80000 , 1200,    100000, 500]);
//R = diag([400, 400, 350, 350]);
//{{-1.86769, -3.74206, -0.785059, -1.5757, -17.908, -2.18029, -4.27987, -0.692731, -4.04958, -0.943469},
//{-1.86769, -3.74206, 0.785059, 1.5757, -4.27987, -0.692731, -17.908, -2.18029, -4.04958, -0.943469},
//{0.523139, 0.993125, -0.848718, -1.76071, 17.2238, 1.66571, -11.1531, -0.887062, -12.0294, -1.95463},
//{0.523139, 0.993125, 0.848718, 1.76071, -11.1531, -0.887062, 17.2238, 1.66571, -12.0294, -1.95463}
...
{{-1.03779, -3.18241, -2.82696, -2.05016, -11.1248, -1.25757, -5.12882, -0.646838, -4.31862, -1.09203},
{-1.03779, -3.18241, 2.82696, 2.05016, -5.12882, -0.646838, -11.1248, -1.25757, -4.31862, -1.09203},
{0.701645, 2.06136, -2.2949, -1.76855, 17.4358, 1.67744, -8.14614, -0.625552, -9.67944, -1.64274},
{0.701645, 2.06136, 2.2949, 1.76855, -8.14614, -0.625552, 17.4358, 1.67744, -9.67944, -1.64274}
};
...
//            wlr.high_set = ramp_calc(&height_ramp, LegLengthHigh);
			wlr.high_set = ramp_calc(&height_ramp, 0.23f);
            x3_balance_zero = 0.0f;
        }
...
static void handle_jump_state(void)
{
    if (wlr.jump_flag == WLR_JUMP_ASCEND && wlr.jump_pre) {
        if (double_cnt <= 0) {
            wlr.v_ref = ramp_calc(&jump_ramp, -0.45f);
        } else {
...
//        x5_balance_zero = 0.10f;
        ...
        x5_balance_zero = 0.0f;
		wlr.sky_cnt++;
		if((wlr.side[0].Fn_kal > 150.0f && wlr.side[1].Fn_kal > 150.0f) || (wlr.sky_cnt > 200))
		{
			wlr.sky_cnt = 0;
...
{
	const static uint16_t swait_time = 500;
...
//        && wlr.sky_over == 0 && wlr.sky_flag == WLR_SKY_IDLE && KEY_PRESS_POWER && yaw_err < 0.5f) {
    ...
    if (wlr.side[index].Fn_kal < 146.0f && rotate_flag == 0 && wlr.high_flag == 1 && chassis.recover_flag == 0
		&& (wlr.sky_flag == WLR_SKY_IDLE) && (yaw_err < 0.5f || 1))  {
        wlr.side[index].fly_cnt += 10;
    } else if (wlr.side[index].fly_cnt > 0) {
        wlr.side[index].fly_cnt -= 20;
        if (wlr.side[index].Fn_kal > 155.0f) {
...
static void map_virtual_force(uint8_t index)
{
    ...
    if (wlr_both_legs_flying() && wlr.jump_flag == WLR_JUMP_IDLE	//两条腿都在空中 && 
        ...
        wlr.side[index].Fy = pid_calc(&pid_L_test[index], tlm.l_ref[index], vmc[index].L_fdb) + 20.0f;
    } 
	else if (wlr.sky_flag == WLR_SKY_EXTENDING) {
...
//		wlr.side[index].Fy = 100.0f;
	...
	if(wlr.sky_flag == WLR_SKY_AIR_FOLDING)
	{
		wlr.side[index].T0 -= 4.0f;
	}
...
void wlr_init(void)
{
	...
	ramp_init(&sky_height_ramp, 0.005f, LegLengthMin, LegLengthMax);		//空中腿长斜坡
	ramp_init(&jump_ramp, 0.007f, -1.5f, 1.5f);
	ramp_init(&wz_ramp, 0.001f,  0,  3.0f);		//
	ramp_init(&sky_ramp[0], 40.0f, -500.0f,  500.0f);							//伸腿支持力斜坡
	ramp_init(&sky_ramp[1], 40.0f, -500.0f,  500.0f);							//伸腿支持力斜坡
...
//		vmc_init(&vmc[i], LegLengthParam);
		...
		pid_init(&pid_leg_recover[i], NONE, 1000, 1.5f, 20000.0f, 100, 300);		//起身专用pid
        pid_init(&pid_leg_length_fly[i], NONE, 600, 0.0, 16000, 0, 150);			//离地腿长/缓冲腿长pid
        pid_init(&pid_L_test[i], NONE, 600, 2.0, 50000, 200, 300);					//日常腿长pid
...
//		off_land_cnt = 0;
//	}
//	if(!wlr_either_leg_flying() && off_land_flag == 1)
//		off_land_flag = 2;
//	if(off_land_flag == 2 && !wlr_either_leg_flying())
//		off_land_cnt++;
...
//	if(off_land_cnt < 100 && off_land_flag == 2)
//	{
//		data_limit(&lqr.X_diff[1], -0.0f, 0.0f);
//	}
//	else if(off_land_cnt > 100)
//	{
//		off_land_cnt = 0;
//		off_land_flag = 0;
//	}
