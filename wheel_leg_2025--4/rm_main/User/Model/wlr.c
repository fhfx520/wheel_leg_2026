...
float left_x3_balance_zero = 0.12f,right_x3_balance_zero = 0.12f;
...
{{-1.65883, -3.42906, -0.708891, -1.42346, -16.0993, -1.54794, -3.6231, -0.533141, -3.59968, -0.871764},
{-1.65883, -3.42906, 0.708891, 1.42346, -3.6231, -0.533141, -16.0993, -1.54794, -3.59968, -0.871764},
{0.543892, 1.05775, -0.786627, -1.6376, 17.0041, 1.37824, -11.0107, -0.807763, -10.0756, -1.6848},
{0.543892, 1.05775, 0.786627, 1.6376, -11.0107, -0.807763, 17.0041, 1.37824, -10.0756, -1.6848}
};
...
{
	const static uint16_t swait_time = 250;
...
static void map_virtual_force(uint8_t index)
{
    ...
    if (wlr_both_legs_flying() && wlr.jump_flag == WLR_JUMP_IDLE	//两条腿都在空中 && 
        ...
        wlr.side[index].Fy = pid_calc(&pid_L_test[index], tlm.l_ref[index], vmc[index].L_fdb) - 0.0f
