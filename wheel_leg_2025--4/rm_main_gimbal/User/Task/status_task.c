...
//        status.dji_motor = dji_motor_check_offline();
        ...
        if (rc_fsm_check(RC_LEFT_LU) || status.remote || ctrl_mode == PROTECT_MODE) { //ÈÅ•ÊéßÂô®ÂàáÊç?DEBUGÁÅ?Êù?
        ...
        } else if (rc_fsm_check(RC_RIGHT_RU)) { //ÈÅ•ÊéßÂô®ÂàáÊç?DEBUGÁÅ?Êù?
